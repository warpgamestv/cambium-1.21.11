...
public class ModModelProvider extends FabricModelProvider {
        ...
        public static final ModelTemplate TINTED_LEAVES = new ModelTemplate(
                        Optional.of(Identifier.fromNamespaceAndPath("minecraft", "block/leaves")), Optional.empty(),
                        TextureSlot.ALL);
        public static final ModelTemplate TINTED_CROSS_OVERLAY = new ModelTemplate(
                        Optional.of(Identifier.fromNamespaceAndPath(Cambium.MOD_ID, "block/tinted_cross_overlay")),
                        Optional.empty(), STEM_SLOT, LEAVES_SLOT);
        public static final ModelTemplate FRUIT_STAGE0 = new ModelTemplate(
                        Optional.of(Identifier.fromNamespaceAndPath(Cambium.MOD_ID, "block/base_fruit_stage0")),
                        Optional.empty(), TextureSlot.ALL);
        public static final ModelTemplate FRUIT_STAGE1 = new ModelTemplate(
                        Optional.of(Identifier.fromNamespaceAndPath(Cambium.MOD_ID, "block/base_fruit_stage1")),
                        Optional.empty(), TextureSlot.ALL);
        public static final ModelTemplate FRUIT_STAGE2 = new ModelTemplate(
                        Optional.of(Identifier.fromNamespaceAndPath(Cambium.MOD_ID, "block/base_fruit_stage2")),
                        Optional.empty(), TextureSlot.ALL);
        ...
        public void generateBlockStateModels(BlockModelGenerators generator) {
                ...
                // Instead of a trivial cube, we use CUBE_COLUMN to separate Top/Bottom from
                // Sides.
                ...
                generator.blockStateOutput.accept(BlockModelGenerators.createSimpleBlock(ModBlocks.ROOT_BLOCK,
                                BlockModelGenerators.plainVariant(rootModel)));
                ...
                Identifier mycelialNodeModel = Identifier.fromNamespaceAndPath(Cambium.MOD_ID, "block/mycelial_node");
                generator.blockStateOutput.accept(BlockModelGenerators.createSimpleBlock(ModBlocks.MYCELIAL_NODE,
                                BlockModelGenerators.plainVariant(mycelialNodeModel)));

                // MYCELIAL_STRAND uses hand-crafted multipart blockstate + models in
                // src/main/resources
                // Do NOT generate a trivial cube here — it would override those files.
                ...
                for (ResourceTree tree : TreeRegistry.TREES) {
                        ...
                        // A. LEAVES
                        Identifier leavesTexture = Identifier.fromNamespaceAndPath(Cambium.MOD_ID,
                                        "block/living_leaves");
                        ...
                        generator.blockStateOutput.accept(MultiVariantGenerator.dispatch(leaves,
                        ...
                        Identifier model0 = FRUIT_STAGE0.createWithSuffix(fruit, "_stage0",
                                        new TextureMapping().put(TextureSlot.ALL, base0), generator.modelOutput);
                        Identifier model1 = FRUIT_STAGE1.createWithSuffix(fruit, "_stage1",
                                        new TextureMapping().put(TextureSlot.ALL, base1), generator.modelOutput);
                        Identifier model2 = FRUIT_STAGE2.createWithSuffix(fruit, "_stage2",
                                        new TextureMapping().put(TextureSlot.ALL, base2), generator.modelOutput);
                        ...
                        Identifier leafOverlayTexture = Identifier.fromNamespaceAndPath(Cambium.MOD_ID,
                                        "block/sapling_leaves");
                        TextureMapping saplingMap = new TextureMapping().put(STEM_SLOT, stemTexture).put(LEAVES_SLOT,
                                        leafOverlayTexture);
                        Identifier saplingModel = TINTED_CROSS_OVERLAY.create(sapling, saplingMap,
                                        generator.modelOutput);
                        generator.blockStateOutput.accept(BlockModelGenerators.createSimpleBlock(sapling,
                                        BlockModelGenerators.plainVariant(saplingModel)));
                }
        }
        ...
        public void generateItemModels(ItemModelGenerators itemModelGenerator) {
                ...
                itemModelGenerator.generateFlatItem(ModItems.PHOTOVOLTAIC_HELMET, ModelTemplates.FLAT_ITEM);
                itemModelGenerator.generateFlatItem(ModItems.PHOTOVOLTAIC_CHESTPLATE, ModelTemplates.FLAT_ITEM);
                itemModelGenerator.generateFlatItem(ModItems.PHOTOVOLTAIC_LEGGINGS, ModelTemplates.FLAT_ITEM);
                itemModelGenerator.generateFlatItem(ModItems.PHOTOVOLTAIC_BOOTS, ModelTemplates.FLAT_ITEM);
                ...
                itemModelGenerator.itemModelOutput.accept(
                                ModBlocks.MYCELIAL_NODE.asItem(),
                                ItemModelUtils.plainModel(Identifier.fromNamespaceAndPath(Cambium.MOD_ID,
                                                "block/mycelial_node")));
                ...
                for (ResourceTree tree : TreeRegistry.TREES) {
                        ...
                        itemModelGenerator.itemModelOutput.accept(
                                        ...
                                        ItemModelUtils.tintedModel(leafBlockModel,
                                                        ItemModelUtils.constantTint(tree.getColor())));

                        // 2. FRUIT
                        Identifier fruitBlockModel = ModelLocationUtils.getModelLocation(tree.getFruit(), "_stage2");
                        itemModelGenerator.itemModelOutput.accept(
                                        tree.getFruit().asItem(),
                                        ItemModelUtils.tintedModel(fruitBlockModel,
                                                        ItemModelUtils.constantTint(tree.getColor())));
                        ...
                        itemModelGenerator.itemModelOutput.accept(tree.getSapling().asItem(),
                                        ItemModelUtils.tintedModel(saplingModelId,
