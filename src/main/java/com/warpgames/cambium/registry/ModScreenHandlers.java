...
public class ModScreenHandlers {
        ...
        public static final MenuType<SolarConcentratorMenu> SOLAR_CONCENTRATOR_SCREEN_HANDLER = Registry.register(
                        BuiltInRegistries.MENU,
        ...
        public static final MenuType<com.warpgames.cambium.screen.MycelialNodeMenu> MYCELIAL_NODE_MENU = Registry
                        .register(BuiltInRegistries.MENU,
                                        Identifier.fromNamespaceAndPath(Cambium.MOD_ID, "mycelial_node_menu"),
                                        new ExtendedScreenHandlerType<>(
                                                        com.warpgames.cambium.screen.MycelialNodeMenu::new,
                                                        BlockPos.STREAM_CODEC //
                                        ));
